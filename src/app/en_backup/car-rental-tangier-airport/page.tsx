...
export default function CarRentalTangierAirportPage() {
      ...
      <div className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Car Rental Tangier Airport
            <span className="block text-2xl md:text-3xl text-blue-200 mt-2">Ibn Battouta Airport</span>
          </h1>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            Tangier Airport car rental service. Pick up your vehicle right upon arrival and explore Morocco freely.
            Nassoh Car offers fair prices and reliable 24/7 service.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
              ...
              <p className="text-blue-100 text-sm">Available for all flights</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
              <MapPin className="h-8 w-8 text-blue-200 mx-auto mb-3" />
              <h3 className="text-white font-semibold mb-2">Fast Pickup</h3>
              <p className="text-blue-100 text-sm">Right at the terminal</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
              <Star className="h-8 w-8 text-blue-200 mx-auto mb-3" />
              <h3 className="text-white font-semibold mb-2">Great Rates</h3>
              <p className="text-blue-100 text-sm">Economy-friendly options</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Our Fleet Available at the Airport</h2>
            <p className="text-gray-600">Choose from our economy selection available for pickup at Ibn Battouta Airport.</p>
          </div>
          {loading ? (
                ...
                <div key={car.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button onClick={() => handleBookNow(car)} className="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition-colors font-semibold">Book Now</button>
                    </div>
                  </div>
                </div>
              ))}
