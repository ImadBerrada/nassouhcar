              ...
              <div className="p-6">
                {loadingBookings ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 text-lg mb-4">Aucune réservation pour le moment</p>
                    <p className="text-gray-500 mb-6">Commencez votre voyage de location de voiture économique dès aujourd'hui !</p>
                    <button
