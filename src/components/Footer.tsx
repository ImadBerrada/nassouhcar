        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="xl:col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <a href="/economy-cars" className="text-gray-300 hover:text-amber-400 transition-all duration-300 text-base hover:translate-x-2 block group">
                  <span className="group-hover:text-white">Voitures Économiques</span>
                </a>
              </li>
              <li>
          ...
          <div className="xl:col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <a href="/location-voiture-france" className="text-gray-300 hover:text-amber-400 transition-all duration-300 text-base hover:translate-x-2 block group">
